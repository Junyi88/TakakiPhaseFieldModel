#ifndef TAKAKISOLVERQUATERNION_H
#define TAKAKISOLVERQUATERNION_H
...
class TakakiSolverQuaternion {
public:
	TakakiSolverQuaternion(TakPhase<FDClass> * inPhi, TakQuaternion<FDAngleClass> * inTheta,
	...
	TakakiSolverQuaternion<FDClass, FDAngleClass> & operator= (
		const TakakiSolverQuaternion<FDClass, FDAngleClass> &in1); //Write to operator
...
// @@ -- Constructor ----------------------------------------------------
template <class FDClass, class FDAngleClass>
TakakiSolverQuaternion<FDClass, FDAngleClass>::TakakiSolverQuaternion(
...
// @@ -- Write over operator ----------------------------------------------------
template <class FDClass, class FDAngleClass>
TakakiSolverQuaternion<FDClass, FDAngleClass> & TakakiSolverQuaternion<FDClass, FDAngleClass>::operator= (
...
// @@ ------------------------------------------------------
template <class FDClass, class FDAngleClass>
void TakakiSolverQuaternion<FDClass, FDAngleClass>::Calc_dEtadt() {
	for (int j = 0; j<_Ny; j++)
		for (int i = 0; i<_NX; i++) {
...
// @@ ------------------------------------------------------
template <class FDClass, class FDAngleClass>
void TakakiSolverQuaternion<FDClass, FDAngleClass>::Update_Eta() {
	for (int j = 0; j<_Ny; j++)
		for (int i = 0; i<_NX; i++) {
...
// @@ ------------------------------------------------------
template <class FDClass, class FDAngleClass>
void TakakiSolverQuaternion<FDClass, FDAngleClass>::Update_Theta() {
	for (int j = 0; j<_Ny; j++)
		for (int i = 0; i<_NX; i++) {
...
// @@ ------------------------------------------------------
template <class FDClass, class FDAngleClass>
void TakakiSolverQuaternion<FDClass, FDAngleClass>::Update_Eta(const double &dtimeCustom) {
	for (int j = 0; j<_Ny; j++)
		for (int i = 0; i<_NX; i++) {
...
// @@ ------------------------------------------------------
template <class FDClass, class FDAngleClass>
void TakakiSolverQuaternion<FDClass, FDAngleClass>::Update_Theta(const double &dtimeCustom) {
	for (int j = 0; j<_Ny; j++)
		for (int i = 0; i<_NX; i++) {
